...
const Main_CustomFrames = () => {
    ...
    // 썸네일 이미지 클릭 시 · 업로드 완료 시 사이즈 수정 UI 반영 (업로드 중 아이템 제외)
    useLayoutEffect(() => {
                    ...
                    img.onload = () => {
                        try {
                            ...
                            const newItem = {
                                ...
                                thumbnailFile: file, // 주문 확정 시 서버로 보낼 원본(또는 HEIF 변환 JPG)
                            ...
                            <UploadAreaTag
                                ...
                                >
                                    ...
                                    <span className="text-sm text-center">
                                        ...
                                        <span className="text-xs text-gray-500">(JPG, PNG, HEIC 파일만 가능, 파일당 최대 50MB)</span>
                                        <br />
                ...
                >
                    ...
                    >
                        ...
                        <div className="flex flex-wrap items-end gap-3 mb-4">
                            ...
                            <span className="text-lg font-semibold text-gray-500 pb-2">x</span>
                            <div className="flex flex-col">
